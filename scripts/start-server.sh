...
DL_URL="$(wget -qO- https://api.github.com/repos/buchen/portfolio/releases/0.65.3 | jq -r ".assets[].browser_download_url" | grep "\-linux.gtk.x86_64.tar.gz" | grep -v ".tar.gz.asc")"
